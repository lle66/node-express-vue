      ...
      <el-menu router :default-openeds="['1']">
        ...
        <el-submenu index="3">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/adminUser/create">新建账户</el-menu-item>
            <el-menu-item index="/adminUser/list">账户列表</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
            <template slot="title">分类</template>
            <el-menu-item index="/cat/create">新建分类</el-menu-item>
            <el-menu-item index="/cat/list">分类列表</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
      </el-menu>
    </el-aside>
